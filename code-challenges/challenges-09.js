...
const arrInc = (arr) => {
  ...
  arr.forEach((e) => result.push(e + 10));
  return result;
};
// -------------------------------------------------------------------------------------------------------
...
const employeesBonus = (arr) => {
  ...
  arr.forEach((e) => {
    if (e.workHours > 8) {
      e.salary =
        (Number(e.salary.slice(0, e.salary.length - 1)) + 100).toString() + "$";
    } else {
      e.salary =
        (Number(e.salary.slice(0, e.salary.length - 1)) + 50).toString() + "$";
    }
    res.push(e);
  });
  return res;
